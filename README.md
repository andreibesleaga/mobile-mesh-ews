...
A separate implementation of the architecture part for the Decision Brain of the System, using BigQuery AI, is listed with documentations and links, in the subdirectory: [BigData_AI_Decision_System](https://github.com/andreibesleaga/mobile-mesh-ews/tree/main/BigData_AI_Decision_System).
