...
* **Privacy-First:** Drones train models _locally_ on video feeds and share only the _weight updates_ (gradients) to the cloud. No raw video of potential survivors leaves the edge unless critically necessary.
